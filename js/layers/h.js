addLayer("h", {
    ...
    buyables: {
        ...
        22: {
            ...
            cost() {
                let a = player[this.layer].buyables[this.id];
                a = Decimal.pow(6, a).mul(hasMilestone("k", 9)?1:1e8);
                return a;
            },
            canAfford() {
                return player.g.points.gte(layers[this.layer].buyables[this.id].cost())
            ...
            effect() {
                let eff = player[this.layer].buyables[this.id].mul(player[this.layer].points.add(10).log10().pow(1.5)).div(hasMilestone("j", 20) ? 40 : 100).add(1);
                return eff;
        ...
        23: {
            ...
            cost() {
                let a = player[this.layer].buyables[this.id];
                a = Decimal.pow(hasMilestone("j", 21)?7:10, a);
                return a;
            },
            canAfford() {
                return player.g.points.gte(layers[this.layer].buyables[this.id].cost())
