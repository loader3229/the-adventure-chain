...
layers.a.resource="经验";
layers.a.effectDescription="";
layers.a.baseResource="生命值";
layers.a.resetDescription="";

layers.a.tabFormat[1][1][0][1]=function(){return "设置敌人等级："};
layers.a.tabFormat[2][1][0][1]=function () { return "当前敌人等级：" + formatWhole(player.a.level) };
